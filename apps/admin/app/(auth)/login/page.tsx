...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-8">
      <section className="w-full max-w-[420px] rounded-lg border bg-card p-8 text-card-foreground shadow-xs">
        ...
        <form action={formAction} className="mt-6 space-y-4" noValidate>
          <div className="space-y-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-md border bg-background px-3 text-sm outline-hidden ring-ring/50 transition focus-visible:ring-2"
              required
            />
