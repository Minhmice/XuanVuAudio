    ...
    <form action={formAction} className="space-y-4" data-testid="policy-page-detail-form">
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full resize-y rounded-md border bg-background px-3 py-2 text-sm text-card-foreground focus:outline-none focus:ring-2 focus:ring-ring"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full resize-y rounded-md border bg-background px-3 py-2 font-mono text-sm text-card-foreground focus:outline-none focus:ring-2 focus:ring-ring"
        />
      </div>
